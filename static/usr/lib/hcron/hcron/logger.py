...
def log_queue(jobid, triggername, username, eventname, eventchainnames, queuetime):
    log_any("queue", jobid, triggername, username, eventname, eventchainnames, queuetime)
